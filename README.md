...
The goal of this repository is to build a **structured, professional, and reproducible lab portfolio**, reinforcing both **practical Azure administration skills** and **exam-oriented knowledge**.

---

## 🎯 Objectives

- Gain hands-on experience with core Azure Administrator tasks
- Reinforce key concepts covered in the AZ-104 exam
- Maintain clear and well-structured technical documentation
- Build a professional portfolio to support job applications and interviews
